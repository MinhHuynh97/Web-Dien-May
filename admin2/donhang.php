        ...
        <div style="text-align: center;" class="row">
            <div style="padding:0"  class="col-md-12">
                ...
                <table class="table table-bordered ">
                    ...
                    $sql_select_donhang= mysqli_query($con,"SELECT * from tbl_donhang as dh,tbl_khachhang as kh where  dh.khachhang_id=kh.khachhang_id group by dh.mahang order by dh.mahang desc ");
                    ...
                    <tr >
                        ...
                        <td >
                            <a href="?quanly=donhang&xoadonhang=<?php echo $row_select_donhang['mahang'] ?>" >Xoá</a>
                            <a href="?quanly=donhang&mahang=<?php echo $row_select_donhang['mahang'] ?>" >Xem đơn hàng</a>
            ...
            <?php
                if( isset($_GET['quanly']) =='donhang' && isset($_GET['mahang']))
                {
                    ...
                    $sql_name = mysqli_query($con, "SELECT name from tbl_khachhang as kh,tbl_donhang as dh where dh.khachhang_id=kh.khachhang_id and dh.mahang='$mahang'");
                    $name = mysqli_fetch_row($sql_name);

            ?>
            <p>Xem chi tiết đơn hàng của khách hàng <?php echo "$name[0]"; ?></p>
