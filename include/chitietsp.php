	...
	<div class="agile_inner_breadcrumb">
		<div class="container">
			<ul class="w3_short">
				...
				?>
				<li><a href="?quanly=danhmuc&id=<?php echo $row_danhmuc_ca['category_id'] ?>"><?php echo $row_danhmuc_ca['category_name'] ?></a></li>
			</ul>
		</div>
	</div>
</div>
						...
						<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
							<form action="?quanly=giohang" method="post">
								<fieldset>
									...
									<input type="submit" name="themgiohang" value="<?php if($row_chitiet['sanpham_soluong']>0){echo "Add to cart";}else{echo "Sold out";} ?>" class="button" />
								</fieldset>
							</form>
						</div>
					</div>
