        ...
        <div class="row">
            ...
            <div class="col-lg-7 single-right-left simpleCart_shelfItem">
                ...
                <p class="mb-3">
                    ...
                    <del
                        class="mx-2 font-weight-light"><?php echo number_format($row_chitiet['sanpham_gia']) ." vnd" ?></del>
                        ...
                        <form action="?quanly=giohang" method="post">
                            <fieldset>
                                ...
                                <input type="submit" name="themgiohang"
                                    value="<?php if($row_chitiet['sanpham_soluong']>0){echo "Add to cart";}else{echo "Sold out";} ?>"
                                    class="button" />
                            </fieldset>
                        </form>
                    </div>
